...
return [
    ...
    'filter'                              => "Filter",
    'total'                              => "Total",
    'forgot_password_introduction_line'     => "Enter your email address and we'll send you an email with instructions to reset your password.",

    'reset_your_password'                   => "Reset Your Password.",
    'reset_password_introduction_line'      => "Reset your password to continue.",
    'export_as'      => "Export as",
    'type'      => "Type",
];
