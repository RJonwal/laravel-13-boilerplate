    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ChangePasswordForm" data-href="{{route('system-users.change-password', $id)}}">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" name="password" class="form-control border-end-0" placeholder="Enter your password" tabindex="2" required autocomplete="new-password">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password_confirmation" name="password_confirmation" class="form-control border-end-0" placeholder="Enter your password" tabindex="2" required autocomplete="new-password">
                                    <div class="input-group-text toggle-password show-password" data-password="false">
                                        <span class="password-eye"></span>
                                    </div>
                                </div>
                    ...
                    <div class="form_btn pb-0">
                        ...
                        <!-- <button type="button" class="fill-btn" data-bs-dismiss="modal">@lang('global.close')</button> -->
                    </div>
                </form>
            </div>
        </div>
