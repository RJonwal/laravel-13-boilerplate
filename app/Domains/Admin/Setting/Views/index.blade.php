                    ...
                    <div class="tab-content p-sm-4 p-3">
                                            ...
                                            @if($contentSetting->type == 'text')
                                                <div class="mb-3 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="tinymce-editor" id="{{$contentSetting->key}}" name="{{$contentSetting->key}}" required >{{$contentSetting->value}}</textarea>
                                                    </div>
                                                </div>
                                            @endif                                            
                                        @endforeach                                         
                        ...
                        <div class="tab-item hide" data-id="support-setting">
                            ...
                            <form class="msg-form" id="supportSettingform" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label class="form-label">
                                                            {{ $supportSetting->display_name }} <span class="required">*</span>
                                                        </label>
                                ...
                                <div class="card-footer rounded-0 px-0 pb-0">
                                    <div class="form-label justify-content-center m-0 text-end">
                                        <button type="submit" class="btn btn-success submitBtnSupport">@lang('global.update')</button>
                                    </div>
                                </div>
                            </form>
                        </div>
